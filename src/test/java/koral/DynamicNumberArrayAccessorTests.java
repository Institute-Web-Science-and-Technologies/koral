 ...
 *
 */
class DynamicNumberArrayAccessorTests {

	private DynamicNumberArrayAccessor dna;
	...
	void setUp() throws Exception {
		dna = new DynamicNumberArrayAccessor(SIZE, 1, DynamicNumberArrayAccessor.DEFAULT_EXTENSION_LENGTH);
	}
	...
	void loadExistingSmallArrayTest() {
		long[] a = { 0, -1, 126, 53, 0, -117, 0, 0 };
		DynamicNumberArrayAccessor newDna = new DynamicNumberArrayAccessor(a, 1, 10);
	...
	void loadExistingBigArrayTest() {
		long[] a = { -1, 0, -26317, 2, 980, 112, 55123, 65535, 0 };
		DynamicNumberArrayAccessor newDna = new DynamicNumberArrayAccessor(a, 3, 10);
	...
	private void assertContent(Number[] array, DynamicNumberArrayAccessor dna) {
		for (int i = 0; i < array.length; i++) {
