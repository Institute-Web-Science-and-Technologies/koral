...
public enum EncodingFileFormat {
  ...
  UUU, EUU, UEU, UUE, EEU, EUE, UEE, EEE, EEEW;

  public boolean isSubjectEncoded() {
    return (this == EUU) || (this == EEU) || (this == EUE) || (this == EEE) || (this == EEEW);
  }

  public boolean isPropertyEncoded() {
    return (this == UEU) || (this == EEU) || (this == UEE) || (this == EEE) || (this == EEEW);
  }

  public boolean isObjectEncoded() {
    return (this == UUE) || (this == EUE) || (this == UEE) || (this == EEE) || (this == EEEW);
  }
