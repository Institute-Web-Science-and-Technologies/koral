...
public abstract class CidreSystem extends Thread implements MessageNotifier {
  ...
  public CidreSystem(Configuration conf, String[] currentAddress, NetworkManager networkManager) {
  ...
  protected static Options createCommandLineOptions() {
    ...
    Option config = Option.builder("c").longOpt("config").hasArg().argName("configFile")
            .desc("the configuration file to use. default is ./cidreConfig.xml").required(false)
            .build();
