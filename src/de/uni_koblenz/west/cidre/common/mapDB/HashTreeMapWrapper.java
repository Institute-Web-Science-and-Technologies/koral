...
public class HashTreeMapWrapper<K, V> extends MapDBMapWrapper<K, V> {
	...
	public HashTreeMapWrapper(MapDBStorageOptions storageType,
			String databaseFile, boolean useTransactions,
			boolean writeAsynchronously, MapDBCacheOptions cacheType,
			String mapName, Serializer<K> keySerializer,
			Serializer<V> valueSerializer) {
		super(storageType, databaseFile, useTransactions, writeAsynchronously,
				cacheType);
		HTreeMapMaker treeMaker = database.createHashMap(mapName)
