...
public class FileChunk implements Comparable<FileChunk> {
  ...
  public FileChunk(int fileID, long sequenceNumber, long totalNumberOfSequences) {
  ...
  public boolean isLastChunk() {
    return totalNumberOfSequences > 0 && sequenceNumber >= totalNumberOfSequences - 1;
  }
  ...
  public String toString() {
    return "FileChunk [fileID=" + fileID + ", sequenceNumber=" + sequenceNumber + "/"
